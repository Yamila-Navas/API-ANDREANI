...
# Configuración
base_url_qa = "https://apisqa.andreani.com" # NO MODIFICAR (es la URL de QA)
user = "user" # Mantener en un lugar seguro
passw = "passw" # Mantener en un lugar seguro
...
parametros_cotizacion = {
    'cpDestino': '5016',    # Reemplaza con el valor real
